...
usage() {
  cat <<'EOF'
Usage:
  scripts/deploy-hotdog-web4.sh <contract-account-id> [testnet|mainnet]

Examples:
  scripts/deploy-hotdog-web4.sh my-hotdog-demo.testnet
  SIGNER_ACCOUNT_ID=my-hotdog-demo.testnet scripts/deploy-hotdog-web4.sh my-hotdog-demo.testnet testnet
...
contract_dir="${repo_root}/hotdog_cnn_contract"
...
wasm_path="${build_target_dir}/near/near_hotdog_cnn_demo.wasm"
...
echo "Building hotdog Web4 contract for ${contract_id} on ${network}..."
(
  cd "${contract_dir}"
